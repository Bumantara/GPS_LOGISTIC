...
hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};(function(){T.fSDec=function(h){for(var m="",w=0;w<h.length;w++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(w));return m};T.obj={wm:"",wmFnSt:"qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg",wmTB:"udyuC`rdmhod",wmFn:"gnou",wmFnS:"ghmmRuxmd",wmFnT:"ghmmUdyu",wmFnClr:"fsdx",wmCtx:"buy",
