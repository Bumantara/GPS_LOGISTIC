  ...
  y = Oa.Chart = (function () {
    ...
    m.prototype._processStackedPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        ...
        for (q in l)
          l.hasOwnProperty(q) &&
            !isNaN(q) &&
            ((a = l[q]), a < d.min && (d.min = Math.min(a, A)), a > d.max && (d.max = a), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, A)), a > d.viewPortMax && (d.viewPortMax = a)));
        for (q in v)
          v.hasOwnProperty(q) &&
            !isNaN(q) &&
            ((a = v[q]), a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, k))));
      }
    };
          ...
          for (p = 0; p < n.dataPoints.length; p++) {
            ...
            if (b < h && !q) null !== e && (r = b);
              ...
              null === e
                ...
                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e), (a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e)), 0 <= e ? (l = !0) : 0 > e && (v = !0), (A[b] = A[b] ? A[b] + Math.abs(e) : Math.abs(e)));
            }
          }
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, v = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          for (n = 0; n < k.dataPoints.length; n++) {
            ...
            l > d.max && (d.max = l);
            0 < n &&
              (a.axisX.logarithmic ? ((r = b / k.dataPoints[n - 1].x), 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff = r)) : ((r = b - k.dataPoints[n - 1].x), 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)),
              e &&
                null !== e[0] &&
                k.dataPoints[n - 1].y &&
        ...
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          for (A = 0; A < v.dataPoints.length; A++)
            if (
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < A &&
                (v.dataPointEOs[A - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = v.dataPointEOs[A - 1].cumulativeSum), v.dataPointEOs[A - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = v.dataPointEOs[A - 1].cumulativeSum));
    ...
    m.prototype._mouseEventHandler = function (a) {
      ...
      m.capturedEventParam &&
        ...
        b.hasOwnProperty(c) && ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture ? (a.target !== b.chart.overlaidCanvas && u) || b[c].call(b.context, d.x, d.y) : a.target !== b.chart.overlaidCanvas && (b.chart.isDrag = !1)));
              ...
              "inside" !== E
                ? ((e = c.x1),
                  ...
                  0 > w
                    ...
                    : ((q = n.point.x + ("horizontal" === B ? 0 : r / 2) + l + b), q > f - A - l - b && ((q = "auto" === E ? Math.min(n.point.x, f) - ("horizontal" === B ? A : A / 2) - l : f - A - l), (y = q < n.point.x))))
            ...
            for (x = !1, m = 0; m < n.length; m++)
              if (((t = n[m].getTime ? n[m].x.getTime() : n[m].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x)))))
                if ("number" !== typeof n[m].y)
                  0 < m && !x && (k.connectNullData ? b.setLineDash && 0 < s.length && (k.options.nullDataLineDashType || !n[m - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = q), (p = k.nullDataLineDashType)) : (d(s), (s = []))),
                    (x = !0);
                else {
              ...
              if (((s = r[h].x.getTime ? r[h].x.getTime() : r[h].x), !(s < a.axisX.dataInfo.viewPortMin || (s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))))
                if ("number" !== typeof r[h].y) g.connectNullData || ja || d || b(), (ja = !0);
                  ...
                  h < r.length - 1 &&
                    ...
                    (b(), (y = r[h].lineColor || w), (f.strokeStyle = y), f.setLineDash && (r[h].lineDashType ? ((c = r[h].lineDashType), f.setLineDash(N(c, g.lineThickness))) : ((c = g.lineDashType), f.setLineDash(P))));
            ...
            for (r = !1; q < p.length; q++)
              if (((g = p[q].x.getTime ? p[q].x.getTime() : p[q].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !r)))))
                if ("number" !== typeof p[q].y)
                  0 < q && !r && (n.connectNullData ? b.setLineDash && 0 < s.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = y), (z = n.nullDataLineDashType)) : (d(), (s = []))),
                    (r = !0);
                else {
                ...
                "number" !== typeof r[h].y
                  ...
                  : ((m = a.axisX.convertValueToPixel(s)),
                    ...
                    h < r.length - 1 &&
                      ...
                      (b(), (y = r[h].lineColor || w), (f.strokeStyle = y), f.setLineDash && (r[h].lineDashType ? ((S = r[h].lineDashType), f.setLineDash(N(S, g.lineThickness))) : ((S = g.lineDashType), f.setLineDash(D)))),
                    (s = g.dataPointIds[h]),
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa))))
                if ("number" !== typeof fa.y) z.connectNullData || aa || x || d(), (aa = !0);
                  ...
                  0 <= z.dataPointIndexes[f] &&
                    ...
                    ((ma = z.getMarkerProperties(z.dataPointIndexes[f], g, r, b)), l.push(ma), (f = Q(F)), u && l.push({ x: g, y: r, ctx: s, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness }));
              ...
              if (
                ...
                "candlestick" === t.type
                  ...
                  : "ohlc" === t.type &&
                    ...
                    c.lineTo(C, q),
                    c.stroke(),
                    u && ((e = Q(D)), (b.strokeStyle = e), b.moveTo(h - y, n), b.lineTo(h - y, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(B, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(C, q), b.stroke()));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          var E = a.dataSeriesIndexes[x],
            ...
            D = 0;
          if (z)
            for (e = B._linkedSeries.id, t = 0; t < e; t++) !this.data[t].type.match(/(bar|column)/gi) || !this.data[t].visible || (this.data[t].type.match(/(stacked)/gi) && D) || (this.data[t].type.match(/(range)/gi) && (f = !0), D++);
          e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
          ...
          f && (v = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? w : 1))) << 0 : 0.03 * this.width);
            ...
            for (var S = !0; g < p.length; g++)
              if (((t = p[g].x.getTime ? p[g].x.getTime() : p[g].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S)))))
                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                  ...
                  q || S
                    ? (n.connectNullData && !q
                        ? (b.setLineDash && (n.options.nullDataLineDashType || (z === n.lineDashType && n.lineDashType !== n.nullDataLineDashType)) && ((m[m.length - 1].newLineDashArray = D), (z = n.nullDataLineDashType), b.setLineDash(y)),
                          b.lineTo(r, s),
                          u && e.lineTo(r, s),
                          m.push({ x: r, y1: s, y2: w }))
            ...
            for (g = !1; p < n.length; p++)
              if (((q = n[p].x.getTime ? n[p].x.getTime() : n[p].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))))
                if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                  ...
                  0 < p &&
                    !g &&
                    (k.connectNullData ? b.setLineDash && 0 < s.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = z), (B = k.nullDataLineDashType)) : (d(C, x), (s = []), (y = []))),
                    (g = !0);
            d(C, x);
            W.drawMarkers(f);
          }
            ...
            for (var E = 5 < q && s.bevelEnabled ? !0 : !1, B = !1, y = null, z = null, l = 0; l < w.length; l++)
              if ((w[l].getTime ? (n = w[l].x.getTime()) : (n = w[l].x), "number" !== typeof w[l].y)) {
                ...
                0 < l &&
                  y &&
                  (!B || s.connectNullData) &&
                  (B && c.setLineDash && c.setLineDash(N(D, t)), c.beginPath(), c.moveTo(y, z - x), c.lineTo(S, P - x), 0 < t && c.stroke(), u && (b.beginPath(), b.moveTo(y, z - x), b.lineTo(S, P - x), 0 < t && b.stroke()));
                B = !1;
                y = F;
                z = 0 < w[l].y ? m : k;
      ...
      for (var n = 0; n < this.dataSeries.length; n++) {
        ...
        if (p.dataPoints && p.dataPoints.length)
          if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
            ...
            q = { markerType: q, markerColor: r, text: g, textBlock: null, chartType: p.type, markerSize: u, lineColor: p._colorSet[0], dataSeriesIndex: p.index, dataPointIndex: null, markerBorderColor: w, markerBorderThickness: t };
            m.push(q);
          } else
        ...
        for (n = 0; n < m.length; n++) {
          ...
          if (!(0 >= l || "undefined" === typeof l || 0 >= w || "undefined" === typeof w)) {
            if ("horizontal" === this.orientation) {
              ...
              if (!p || p.width + Math.round(q.textBlock.width + u + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f)
                  ...
                  if (
                    ...
                    this.labelWrap
                      ? s(this.options.labelMaxWidth)
                        ? ((this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), n)), (this.sessionVariables.labelWrap = this.labelWrap), d && (r.width + d.width) >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                        : ((this.sessionVariables.labelWrap = this.labelWrap),
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                c[g].labelAutoFit &&
                  !s(x) &&
                  (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, x) : 0 === c[g].labelAngle ? Math.max(l, x / 2) : l), 0 < !d.length && (m = 0 < c[g].labelAngle ? m - y / 2 : 0 === c[g].labelAngle ? m - y / 2 : m)),
        ...
        for (var d = this, c, b = 0, e = 0, f = !1, l = !1, h = [], m = [], l = !1, b = 0; b < this.stripLines.length; b++) {
          ...
          k._thicknessType === a &&
            (("pixel" === a && (k.value < this.viewportMinimum || k.value > this.viewportMaximum || s(k.value) || isNaN(this.range))) ||
              ("value" === a &&
                ((k.startValue <= this.viewportMinimum && k.endValue <= this.viewportMinimum) || (k.startValue >= this.viewportMaximum && k.endValue >= this.viewportMaximum) || s(k.startValue) || s(k.endValue) || isNaN(this.range))) ||
              h.push(k));
        }
        ...
        if ("axisX" === this.type && c) {
          this.intervalType ||
            (b / 1 <= a
              ...
              : ((this.interval = b / (1 * R.yearDuration) <= a ? 1 : b / (2 * R.yearDuration) <= a ? 2 : b / (4 * R.yearDuration) <= a ? 4 : Math.floor(D.getNiceNumber(b / (a - 1), !0) / R.yearDuration)), (this.intervalType = "year")));
    ...
    D.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      1 === this.viewportMaximum &&
        ...
        this.options && "undefined" === typeof this.options.interval && ((this.interval = D.getNiceExponent(Math.ceil(Math.log(l) / d) / (a - 1))), (c = D.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0))));
      if (null === this.minimum || null === this.maximum)
        "axisX" === this.type
      ...
      if (0 !== this.spacing || (0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness))) {
        ...
        if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
          if (
            ...
            "top" === this.scaleBreaks.parent._position ? ((e = this.chart.plotArea.y1), (h = (this.chart.plotArea.y2 + p / 2 + 0.5) << 0)) : ((e = this.chart.plotArea.y2), (h = (this.chart.plotArea.y1 - p / 2 + 0.5) << 0), (a *= -1)),
          ...
          if (
            ...
            "left" === this.scaleBreaks.parent._position ? ((b = this.chart.plotArea.x1), (l = (this.chart.plotArea.x2 + p / 2 + 0.5) << 0)) : ((b = this.chart.plotArea.x2), (l = (this.chart.plotArea.x1 - p / 2 + 0.5) << 0), (a *= -1)),
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
              ...
              if ("axisX" === this.parent.type)
                for (r = this.parent.convertPixelToValue({ y: d }), u = null, w = 0; w < this.parent.dataSeries.length; w++)
                  (u = this.parent.dataSeries[w].getDataPointAtX(r, !0)) &&
                    0 <= u.index &&
                    (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : s(this.options.label) ? u.dataPoint.label : this.label);
            } else
          ...
          if (
            ...
            "waterfall" === this.parent.dataSeries[w].type
              ? ((m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0),
                (k.text = this.labelFormatter
        ...
        for (var s = null, k = "", m = 0; m < a.length; m++)
          (c = a[m].dataSeries),
            ...
            null === b.toolTipContent ||
              ...
              null === d && (d = ""),
              !0 === this.reversed ? ((d = this.chart.replaceKeywordsWithValue(f, b, c, e) + d), m < a.length - 1 && (d = "</br>" + d)) : ((d += this.chart.replaceKeywordsWithValue(f, b, c, e)), m < a.length - 1 && (d += "</br>")));
        null !== d && (d = k + d);
      } else {
        c = a[0].dataSeries;
        b = a[0].dataPoint;
      ...
      W = {
        drawMarker: function (a, d, c, b, e, f, h, m) {
          if (c) {
            ...
            "circle" === b
              ? (c.moveTo(a, d), c.beginPath(), c.arc(a, d, e / 2, 0, 2 * Math.PI, !1), f && c.fill(), m && (h ? c.stroke() : ((s = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = s))))
              : "square" === b
